...
banner() {
    ...
    cat <<- EOF
		...
		${RED}│${GREEN}░░░░▀░░▀▀▀░▀░▀░▀░▀░▀▀▀░▀░▀░░░▀▀░░▀▀▀░▀▀▀░▀░▀░░▀░░▀▀▀░▀░░░░${RED}│
		${RED}└──────────────────────────────────────────────────────────┘
		${BLUE}By : Aditya Shakya // @adi1090x, fork by @barnacl437
	EOF
}
...
usage() {
	banner
	echo This is a version using apt instead of pkg due to proot not allowing to run pkg
	echo in root mode. Working in progress and experimental.
